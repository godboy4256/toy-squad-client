...
type ProjectNewContentProps = {
  width?: number;
};

export const ProjectNewTitle = styled.h2`
...
export const ProjectNewContainer = styled.div`
  padding: 100px 0;
  margin: 0 auto;
`;

export const ProjectNewValueTitle = styled.h3`
  font-size: 1.6rem;
  font-weight: 700;
  padding-bottom: 5px;
`;
export const ProjectNewSkillsWrapper = styled.div`
  border: 1px solid #ccc;
  border-radius: 5px;
  padding: 20px;
`;
export const ProjectNewContent = styled.div`
  width: ${(props: ProjectNewContentProps) =>
    `calc(${props.width}% - 20px)` || "100%"};
  padding-bottom: 30px;
`;
export const ProjectNewInputGrid = styled.div`
  display: flex;
  width: 100%;
  column-gap: 20px;
`;
